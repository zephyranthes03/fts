...
@router.get("/{id}", response_description="Diagnosises retrieved")
async def get_diagnosis(id:str, dependencies:dict=Depends(verify_token)):
...
@router.delete("/{id}", response_description="Diagnosis data deleted from the database")
