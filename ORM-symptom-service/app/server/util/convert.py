...
async def symptom_list_to_dict(symptom_list:list) -> dict:
    ...
    symptom_dict = dict()
    symptom_menu_item = ['id','symptom','area','occur_pattern','ages','sex','bmi','diagnosis','image_file']
...
async def disease_list_to_dict(disease_list:list) -> dict:
    ...
    disease_dict = dict()
    disease_menu_item = ['id','symptom','area','occur_pattern','ages','sex','diagnosis','image_file']
...
async def sampleimage_list_to_dict(sampleimage_list:list) -> dict:
    ...
    sampleimage_menu_item = ['id','symptom','area','occur_pattern','ages','sex','bmi','diagnosis','image_file']
